...
<head>
    ...
    <title>Descubra sua E-Bike Ideal | eBike Solutions</title>
...
<body
    ...
    <main
        class="flex-1 flex flex-col justify-center items-center relative w-full h-full overflow-y-auto overflow-x-hidden">
        ...
        <div x-show="step === 0" x-transition:leave="transition ease-in duration-500 opacity-0 -translate-x-20"
            ...
            <p class="text-lg md:text-xl text-slate-300 max-w-2xl font-medium leading-relaxed drop-shadow-md">
                ...
                elegível para o <span class="text-brand-neon font-bold">Bônus de Acessórios Blindados</span>.
            </p>
            ...
            <div
                ...
                <div x-show="step === 4" x-cloak x-transition:enter="transition ease-out duration-500 delay-200"
                    ...
                    <div class="text-center space-y-2">
                        ...
                        <p class="text-slate-300">Insira seu WhatsApp para receber a Ficha Técnica e o Bônus.</p>
                    </div>

                    <form @submit.prevent="submitForm" class="space-y-5 relative z-30">
                        <div class="space-y-4">
                            <div class="group">
                                <label class="block text-xs font-bold text-brand-neon uppercase mb-1 ml-1">Seu Nome
                                    *</label>
                            ...
                            <div class="group">
                                <label class="block text-xs font-bold text-brand-neon uppercase mb-1 ml-1">WhatsApp *
                                    (DDD + Número)</label>
                                <input type="tel" x-model="contact.phone" required
                                    class="relative z-30 w-full p-4 bg-brand-base/50 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:border-brand-neon focus:ring-1 focus:ring-brand-neon outline-none transition-all cursor-text"
                ...
                <div x-show="step === 5" x-cloak x-transition:enter="transition ease-out duration-700"
                    ...
                    <div x-show="totalScore >= 30" class="space-y-6">
                        ...
                        <h2 class="text-2xl md:text-3xl font-bold text-white leading-tight">RESULTADO: A Bike Ideal para
                            você é a <span class="text-brand-neon">Lyam X-Pro</span></h2>
                        <p class="text-lg text-white/90 bg-brand-neon/10 border border-brand-neon/20 p-4 rounded-xl">
                            🔥 <span class="font-bold text-brand-neon">Ótima notícia:</span> Você foi APROVADO para o
                            Bônus de Kit Acessórios (R$ 450,00). <br /><span class="text-sm opacity-80">Mas atenção:
                                Temos apenas 3 unidades.</span>
                        </p>
                        ...
                        <a href="https://api.whatsapp.com/send?phone=5511987654321&text=Ol%C3%A1%2C%20fiz%20o%20quiz%20e%20deu%20a%20bike%20X.%20Quero%20garantir%20meu%20b%C3%B4nus%20de%20acess%C3%B3rios.%20Tenho%20urg%C3%AAncia."
                            target="_blank"
                            class="w-full bg-brand-neon hover:bg-white text-brand-base font-bold py-4 rounded-xl shadow-lg hover:shadow-neon transition-all transform hover:-translate-y-0.5 flex justify-center items-center animate-pulse-slow text-center leading-tight px-4 cursor-pointer">
                    ...
                    <div x-show="totalScore >= 15 && totalScore < 30" class="space-y-6">
                        ...
                        <div
                            class="w-full aspect-video bg-brand-base border border-white/10 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden group">
                            <div
                                class="absolute inset-0 bg-brand-neon/5 group-hover:bg-brand-neon/10 transition-colors">
                            </div>
                            <svg class="w-16 h-16 text-brand-neon opacity-80 mb-2" fill="currentColor"
                                viewBox="0 0 20 20">
                                <path
                                    d="M6.3 2.841A1.5 1.5 0 004 4.11V15.89a1.5 1.5 0 002.3 1.269l9.344-5.89a1.5 1.5 0 000-2.538L6.3 2.84z">
                                </path>
                            </svg>
                            <span class="text-xs text-slate-400 uppercase tracking-widest">Vídeo de Apresentação</span>
                        </div>
                        ...
                        <a href="https://api.whatsapp.com/send?phone=5511999999999&text=Oi%2C%20vi%20o%20v%C3%ADdeo%20da%20bike%20Y%20e%20quero%20saber%20sobre%20parcelamento."
                            target="_blank"
                            class="w-full bg-brand-neon hover:bg-white text-brand-base font-bold py-4 rounded-xl shadow-lg hover:shadow-neon transition-all transform hover:-translate-y-0.5 flex justify-center items-center text-center px-4 cursor-pointer">
                    ...
                    <div x-show="totalScore < 15" class="space-y-8">
                        ...
                        <a href="https://www.instagram.com/ebikesolutions" target="_blank"
                            class="w-full border-2 border-brand-neon text-brand-neon hover:bg-brand-neon hover:text-brand-base font-bold py-4 rounded-xl transition-all transform hover:-translate-y-0.5 flex justify-center items-center text-center px-4 cursor-pointer">
        ...
        <div x-show="step === 'processing'" x-cloak x-transition:enter="transition ease-out duration-500"
            ...
            <h2 class="text-2xl md:text-3xl font-bold text-white mb-2" x-text="processingMessage"></h2>
    ...
    <script>
        function quizApp() {
            return {
                ...
                isSubmitting: false,
                processingMessage: '',
                // 🇺🇸 International Standard Tracking
                tracking: {
                ...
                questions: [
                    { id: 'q1', text: "Missão Principal", options: [{ label: "Fugir do trânsito", score: 10 }, { label: "Renda Extra", score: 10 }, { label: "Uso Misto", score: 5 }, { label: "Lazer", score: 0 }] },
                    { id: 'q2', text: "Trajeto", options: [{ label: "Subidas/Longo", score: 10 }, { label: "Plano/Médio", score: 5 }, { label: "Curto/Bairro", score: 0 }] },
                    { id: 'q3', text: "Prazo", options: [{ label: "Imediato", score: 20 }, { label: "30 dias", score: 10 }, { label: "Futuro", score: 0 }] }
                ],
                answers: { q1: null, q2: null, q3: null },
                scores: { q1: 0, q2: 0, q3: 0 },
                contact: { name: '', email: '', phone: '', instagram: '' },

                get totalScore() { return this.scores.q1 + this.scores.q2 + this.scores.q3; },
                ...
                selectOption(questionIndex, option) {
                    ...
                    setTimeout(() => {
                        if (questionIndex === this.questions.length - 1) this.startProcessing();
                        else this.nextStep();
                    }, 350);
                },
                nextStep() { this.step++; this.updateProgress(); },
                startProcessing() {
                    this.step = 'processing';
                    this.progress = 85;
                    this.processingMessage = '🔄 Analisando topografia...';
                    setTimeout(() => { this.processingMessage = '✅ Calculando potência...'; }, 1000);
                    setTimeout(() => { this.processingMessage = '🎁 Verificando bônus...'; }, 2000);
                    setTimeout(() => { this.step = 4; this.updateProgress(); }, 3000);
                },
                updateProgress() {
                    const steps = { 0: 10, 1: 35, 2: 60, 3: 85, 4: 90, 5: 100 };
                    this.progress = steps[this.step] || 100;
                },
                async submitForm() {
                    // BLINDAGEM DE VALIDAÇÃO (FRONT-END)
                    // 1. Nome Obrigatório
                    ...
                    // 2. WhatsApp Completo (DDD + 8 ou 9 dígitos)
                    const cleanPhone = this.contact.phone.replace(/\D/g, '');
                    if (cleanPhone.length < 10) {
                        alert("WhatsApp inválido. Digite o DDD + Número completo.");
                        return;
                    }
                    ...
                    const payload = {
                        ...
                        email: this.contact.email, // Opcional
                        quiz_mission: this.answers.q1,
                        quiz_path: this.answers.q2,
                        quiz_timeline: this.answers.q3,
